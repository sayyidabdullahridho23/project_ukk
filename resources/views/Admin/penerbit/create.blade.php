                    ...
                    <form action="{{ route('admin.penerbit.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_penerbit') is-invalid @enderror" 
                                   id="kode_penerbit" name="kode_penerbit" value="{{ old('kode_penerbit') }}" required>
                            @error('kode_penerbit')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_penerbit') is-invalid @enderror" 
                                   id="nama_penerbit" name="nama_penerbit" value="{{ old('nama_penerbit') }}" required>
                            @error('nama_penerbit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('alamat_penerbit') is-invalid @enderror" 
                                   id="alamat_penerbit" name="alamat_penerbit" value="{{ old('alamat_penerbit') }}" required>
